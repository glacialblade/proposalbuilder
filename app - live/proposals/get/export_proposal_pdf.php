...
/* ==================COVER PAGE================= */
	...
	if($proposal->proposal_type_id == 1){
	$html = <<<EOF
	<img src="http://reportbuilder.bristonoutsourcing.com/app/classes/tcpdf/images/briston_bg.jpg" />
EOF;
	}
	else if($proposal->proposal_type_id == 2){
	$html = <<<EOF
	<img src="http://reportbuilder.bristonoutsourcing.com/app/classes/tcpdf/images/boss_bg.jpg" />
EOF;
	}

<?php
	...
	if($proposal->proposal_type_id == 1){
		$header = 'http://reportbuilder.bristonoutsourcing.com/app/classes/tcpdf/images/briston_header.jpg';
		$footer = 'http://reportbuilder.bristonoutsourcing.com/app/classes/tcpdf/images/briston_footer.jpg';
		$tab_stops = 'center 3.0in right 0.0in';
		$cover_page = '<img src="http://reportbuilder.bristonoutsourcing.com/app/classes/tcpdf/images/briston_bg.jpg" />';
	}
	else{
		$header = 'http://reportbuilder.bristonoutsourcing.com/app/classes/tcpdf/images/boss_header.jpg';
		$footer = 'http://reportbuilder.bristonoutsourcing.com/app/classes/tcpdf/images/boss_footer.jpg';
		$tab_stops = 'center 3.0in right 7.5in';
		$cover_page = '<img src="http://reportbuilder.bristonoutsourcing.com/app/classes/tcpdf/images/boss_bg.jpg" />';
	}
...
<v:shape id="_x0000_s1025" type="#_x0000_t75" alt="" style='position:absolute;
    ...
    <v:imagedata src="http://reportbuilder.bristonoutsourcing.com/app/classes/tcpdf/images/briston_header.jpg"/>
    <w:wrap type="square"/>
</v:shape>
<![endif]-->
